...
export const Heart = ({width = 33, height = 29, color='currentColor'}: SvgProps) => {
    return (
        <svg width={width} height={height} style={{ fill: `var(--heart-fill, none)`, strokeWidth: 'var(--stroke-width)' }} stroke={color} xmlns="http://www.w3.org/2000/svg">
