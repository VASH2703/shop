...
export const Arrow = ({width = 16, height = 8, angle, color='currentColor'}: ArrowProps) => {
    return (
        <svg transform= {angle ? `rotate(${angle} 0 0)` : undefined} width={width} height={height} fill={color} xmlns="http://www.w3.org/2000/svg">
