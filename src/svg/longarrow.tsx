...
export const LongArrow = ({width = 32, height = 6, color='currentColor'}: SvgProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 32 6" fill={color} xmlns="http://www.w3.org/2000/svg">
