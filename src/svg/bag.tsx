...
export const Bag = ({width = 32, height = 35, color='currentColor', className}: SvgProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 35 35" fill="none" style={{ strokeWidth: 'var(--stroke-width)' }} className={className} xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M9.33301 16.6666L9.33301 7.66663C9.33301 3.98473 12.3178 0.99996 15.9997 0.99996V0.99996C19.6816 0.99996 22.6663 3.98473 22.6663 7.66663L22.6663 16.6666" stroke={color} strokeLinecap="round"/>
        </svg>
    );
};